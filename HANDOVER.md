...
**Stand:** 2026-08-02 · **Letzter Release:** v0.6.1 (live, APK + latest.json verifiziert; Overlay-Bubble mit funktionierendem Touch — am Gerät getestet: Tap+Drag ok) · **Repo:** `Labushuya/overlai` (public) · **Lokal:** `C:\Code\claude\apps\overlai`
